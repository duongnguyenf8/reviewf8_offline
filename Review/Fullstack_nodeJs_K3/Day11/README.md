# Dương Hiệp + Tuyết đánh giá bài học viên
...
- [x] [Bài 2] Màn hình: max-width: 1399px
  ...
  Kích thước của các item trong phần `delivery` to hơn so với thiết kế
...
- Phần `footer` khoảng cách phía trên đang nhỏ hơn bài mẫu.
